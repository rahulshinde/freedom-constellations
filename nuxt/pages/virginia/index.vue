<template>
  <main class="w-full overflow-hidden">
    <div class="relative">
      <BlockTextHeading class="relative z-20" text="Virginia: Turning building and busses into megaphones for youth" />
      <BlockTextBody class="!mt-0 relative z-20" text="As Richmond dismantled monuments to their painful and devastating legacy of slavery and the confederacy, Freedom Constellations (2020-2022) represented a new, interactive series of monumental public art projects that asked young people to illustrate a road map toward freedom for us all." />
    ...
    >
      ...
      <div class="relative">
        <img class="absolute -z-[1] -top-[15vw] left-[20vw] w-[35vw]" src="/zine-assets/planet1.png" />
        <img class="absolute -z-[1] top-[5vw] left-[20vw] w-[18vw]" src="/zine-assets/greenstar.png" />
        <IndexLink
        class="relative z-10"
...
"
        />
        <img class="absolute -z-[1] rotate-45 bottom-[2rem] right-[4rem] w-[15vw]" src="/zine-assets/zine-assets_0014_Layer-4.png" />
